...
pt P(pt A, float s, pt B) {return P(A.x+s*(B.x-A.x),A.y+s*(B.y-A.y)); };                             // A+sAB (Linear interpolation)
...
class pt { float x=0,y=0; 
  ...
  pt show() {ellipse(x, y, 6, 6); return this;}                 
  pt show(float r) {ellipse(x, y, r, r); return this;}                 
  pt label(String S) {scribe(S,x,y); return this;}                 
  } // end of pt class
