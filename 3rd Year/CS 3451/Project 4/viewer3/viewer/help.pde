void writeHelp () {fill(dblue);
    ...
    scribe("Particle Generator: g: move generator, r: decrease radius, R: increase radius, l:decrease particle interval, L:increase interval",  i++);
...
void writeFooterHelp (float vScalar) {fill(dbrown);
    scribeFooter("Joon Ki Hong & Krista Patel Project 4.  Press ?:help.  velocityScalar="+vScalar+" particle interval="+particleGenerator.interval,1);
  }
