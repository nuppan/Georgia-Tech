...
public class CircularArraySequenceTest  {
	...
	public void testConcat() {
		/* Uncomment these following lines if you are implementing this as
		 * extra credit.
		seq.append("a");
		seq.append("b");
		seq.append("c");
	...
	public void testContainsSequenceOfT() {
		/*
		 * Uncomment these tests if you implement this function for 
		 * extra credit
		seq.append("a");
		seq.append("b");
		seq.append("c");
	...
	public void testContainsT() {
		/*
		 * Uncomment these lines if you did this function
